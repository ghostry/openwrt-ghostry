...
define Profile/TLWR740NV5
	NAME:=TP-LINK TL-WR740N v5
	PACKAGES:=kmod-usb-core kmod-usb2
endef

define Profile/TLWR740NV5/Description
	Package set optimized for the TP-LINK TL-WR740N v5.
endef

$(eval $(call Profile,TLWR740NV5))
...
define Profile/TLWR841NV8
	NAME:=TP-LINK TL-WR841N v8
	PACKAGES:=
endef

define Profile/TLWR841NV8/Description
	Package set optimized for the TP-LINK TL-WR841N v8.
endef

$(eval $(call Profile,TLWR841NV8))
