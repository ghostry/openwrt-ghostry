...
#define AP121_KEYS_DEBOUNCE_INTERVAL	3 
...
static struct gpio_button ap121_gpio_keys[] __initdata = {
	{
		.desc		= "jumpstart button",
		.type		= EV_KEY,
		.code		= KEY_WPS_BUTTON,
		.threshold = AP121_KEYS_DEBOUNCE_INTERVAL,
...
static struct gpio_button ap121_mini_gpio_keys[] __initdata = {
	{
		.desc		= "jumpstart button",
		.type		= EV_KEY,
		.code		= KEY_WPS_BUTTON,
