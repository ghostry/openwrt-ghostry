...
#define UBNT_KEYS_DEBOUNCE_INTERVAL	3
...
static struct gpio_button ubnt_gpio_keys[] __initdata = {
	{
		.desc		= "sw4",
		.type		= EV_KEY,
		.code		= KEY_RESTART,
		.threshold = UBNT_KEYS_DEBOUNCE_INTERVAL,
		.gpio		= UBNT_RS_GPIO_SW4,
		.active_low	= 1,
	}
};

static struct gpio_button ubnt_m_gpio_keys[] __initdata = {
	{
		.desc		= "reset",
		.type		= EV_KEY,
		.code		= KEY_RESTART,
