...
#define TL_WR841ND_V1_KEYS_DEBOUNCE_INTERVAL 3 
...
static struct gpio_button tl_wr841n_v1_gpio_keys[] __initdata = {
	{
		.desc		= "reset",
		.type		= EV_KEY,
		.code		= KEY_RESTART,
		.threshold = TL_WR841ND_V1_KEYS_DEBOUNCE_INTERVAL,
